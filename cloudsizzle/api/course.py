...
# NOTE: the opening of sibconnections should really not happen here
# A nice pythonesque way of making the connection available is needed.
# Also do these preserve unicode characters?

def search(query):
    """Search for courses whose course code or name contains the query string."""
    sc = SIBConnection('Course gatherer', method='preconfigured')
