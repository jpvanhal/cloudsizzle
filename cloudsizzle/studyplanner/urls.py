...
urlpatterns = patterns('',
    ...
    url(
        ...
        name='friendscourses'),
    url(r'^profile/(?P<user_id>[a-zA-Z0-9-_]+)/courses/planned/?$', 'studyplanner.frontpage.views.planned_courses', name='plannedcourses'),
    url(
        r'^profile/courses/planned/add/$',
        'studyplanner.frontpage.views.add_to_planned_courses',
        name='add_to_planned_courses'),
    url(r'^profile/courses/planned/remove/$', 
